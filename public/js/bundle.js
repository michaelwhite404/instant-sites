...
},{}],"sites.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editSiteStatus = exports.editInstantSite = exports.createInstantSite = void 0;
...
var createInstantSite = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(businessName, firstName, lastName, phoneNumber, cellPhone, email, streetAddress, suite, city, state, zip, country, industry) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Instant Site Created!");
              window.setTimeout(function () {
                location.assign("/instant-sites/sites/".concat(res.data.data.newSite.customId, "/").concat(res.data.data.newSite.slug));
              }, 1750);
            }
  ...
  return function createInstantSite(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13) {
    return _ref.apply(this, arguments);
  };
}();

exports.createInstantSite = createInstantSite;

var editInstantSite = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(businessName, firstName, lastName, phoneNumber, cellPhone, email, streetAddress, suite, city, state, zip, country, id) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Edit Successful");
              window.setTimeout(function () {
                location.assign("/instant-sites/sites/".concat(res.data.data.site.customId, "/").concat(res.data.data.site.slug));
              }, 1750);
            }
  ...
  return function editInstantSite(_x14, _x15, _x16, _x17, _x18, _x19, _x20, _x21, _x22, _x23, _x24, _x25, _x26) {
    return _ref2.apply(this, arguments);
  };
}();

exports.editInstantSite = editInstantSite;

var editSiteStatus = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(id, status) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Status changed to ".concat(res.data.data.site.status));
              window.setTimeout(function () {
                location.reload();
              }, 1750);
            }
  ...
  return function editSiteStatus(_x27, _x28) {
...
exports.toggleColorScheme = exports.editUser = exports.createUser = void 0;
...
var createUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstName, lastName, title, email, phoneNumber, role) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "User Created! A password has been sent to the user's email.");
              window.setTimeout(function () {
                location.assign("/users/".concat(res.data.data.newUser.slug));
              }, 1750);
            }
...
var editUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(firstName, lastName, title, email, phoneNumber, role, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              ...
              window.setTimeout(function () {
                location.assign("/users/".concat(res.data.data.user.slug));
              }, 1750);
            }
  ...
  return function editUser(_x7, _x8, _x9, _x10, _x11, _x12, _x13) {
    return _ref2.apply(this, arguments);
  };
}();
...
var toggleColorScheme = /*#__PURE__*/function () {
  ...
  return function toggleColorScheme() {
    return _ref3.apply(this, arguments);
  };
}();

exports.toggleColorScheme = toggleColorScheme;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"csv.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.save = exports.headerChecker = exports.logTable = void 0;

var logTable = function logTable(results) {
  ...
  if ($(".content-top .upload-button-wrapper").length == 0) {
    ...
    $uploadButtonWrapperClone.find(".upload-button").css({
      width: "45px",
      height: "45px"
    });
    $uploadButtonWrapperClone.find("svg").attr("width", "20px").attr("height", "20px");
    $(".inner-content-wrapper").remove();
    $uploadButtonWrapperClone.appendTo(".content-top").css({
      opacity: 0
    }).animate({
      opacity: 1
    }, 1500);
  ...
  var thArray = ["Business Name", "Phone", "Email", "Address", "Suite", "City", "State", "Zip", "Country"];
  var tableHeadDatas;
  $.each(thArray, function (index, value) {
    tableHeadDatas += "<th>".concat(value, "</th>");
  });
  $csvTableHTML.append("<thead>").children("thead").append("<tr>").children("tr").append(tableHeadDatas);
  var tableBodyRows;
  $.each(csvData, function (index, value) {
    tableBodyRows += "<tr>";
    tableBodyRows += "<td title='".concat(value.Name || "", "'>").concat(value.Name || "", "</td>");
    tableBodyRows += "<td title='".concat(value.Phone || "", "'>").concat(value.Phone || "", "</td>");
    tableBodyRows += "<td title='".concat(value.Email || "", "'>").concat(value.Email || "", "</td>");
    tableBodyRows += "<td title='".concat(value.Address || "", "'>").concat(value.Address || "", "</td>");
    tableBodyRows += "<td title='".concat(value.Suite || "", "'>").concat(value.Suite || "", "</td>");
    tableBodyRows += "<td title='".concat(value.City || "", "'>").concat(value.City || "", "</td>");
    tableBodyRows += "<td title='".concat(value.State || "", "'>").concat(value.State || "", "</td>");
    tableBodyRows += "<td title='".concat(value.Zip || "", "'>").concat(value.Zip || "", "</td>");
    tableBodyRows += "<td></td>";
    tableBodyRows += "</tr>";
  });
  $csvTableHTML.append("<tbody>").children("tbody").append(tableBodyRows);
  $csvTableHTML.append("<tfoot>").children("tfoot").append("<tr>").children("tr").append("<td colspan='9'>").children("td").append("<div class='tfoot-container'>").children("div");
...
var headerChecker = function headerChecker(results) {
  console.log(results, "HERE");
  var target = ["businessName", "firstName", "lastName", "phoneNumber", "email", "cellPhone", "streetAddress", "suite", "city", "state", "zip", "country"];
  target.every(function (v) {
    return results.includes(v);
  });
};
  ...
  $("input#csv-upload").parse({
    config: {
      ...
      complete: function complete(results) {
        $.each(results.data[0], function (index, value) {
          arr[index] = value;
        });
...
// DOM ELEMENTS
var createInstantSiteForm = $("#create-instant-site-form");
var editInstantSiteForm = $("#edit-instant-site-form");
var loginForm = $("#login-form");
var logOutBtn = $("#log-out-button");
var createUserForm = $("#create-user-form");
var editUserForm = $("#edit-user-form");
var colorSchemeBtn = $("#dark-mode-check");
var bulkSiteForm = $("#create-bulk-instant-site-form");
var changeStatusForm = $("#change-status-form");

if (createInstantSiteForm) {
  $(createInstantSiteForm).on("submit", function (e) {
    e.preventDefault();
    ...
    (0, _sites.createInstantSite)(businessName, firstName, lastName, phoneNumber, cellPhone, email, streetAddress, suite, city, state, zip, country, industry);
  });
}
...
if (editInstantSiteForm) {
  ...
  $(editInstantSiteForm).on("submit", function (e) {
    e.preventDefault();
    var businessName = $("#business-name").val();
    var firstName = $("#first-name").val() || "";
    var lastName = $("#last-name").val();
    ...
    var zip = $("#zip").val();
    var country = $("#country").val();
    (0, _sites.editInstantSite)(businessName, firstName, lastName, phoneNumber, cellPhone, email, streetAddress, suite, city, state, zip, country, id);
  });
}
...
if (createUserForm) {
  $(createUserForm).submit(function (e) {
    ...
    var phoneNumber = $("#phone-number").val();
    var role = $("#role").val();
    (0, _users.createUser)(firstName, lastName, title, email, phoneNumber, role);
  });
}
...
if (editUserForm) {
  $(editUserForm).submit(function (e) {
    ...
    var phoneNumber = $("#phone-number").val();
    var role = $("#role").val();
    var id = $("form").attr("data-user-id");
    (0, _users.editUser)(firstName, lastName, title, email, phoneNumber, role, id);
  });
}

if (colorSchemeBtn) {
  $(colorSchemeBtn).on("change", function (e) {
    e.preventDefault();
    (0, _users.toggleColorScheme)();
  });
}

var resetPage = function resetPage(wrapper) {
  $(".database-wrapper").empty();
...
if (bulkSiteForm) {
  ...
  $("#csv-upload").on("change", function () {
    ...
    if (ext !== "csv") {
      ...
      (0, _alerts.showAlert)("error", "Please upload csv file only.");
      return;
    } // Test headers


    var headerArray = (0, _csv.save)();
    ...
    $("#file-selected").html(fileName); // Parse the csv

    tableShown = true;
    $("input#csv-upload").parse({
      config: {
        header: true,
        complete: _csv.logTable
      },
